...
G_DEFINE_TYPE (ScdmClient, scdm_client, G_TYPE_OBJECT);
...
scdm_client_get_open_connection (ScdmClient *client)
{
...
static GDBusConnection *
scdm_client_get_connection_sync (ScdmClient      *client,
                                GCancellable   *cancellable,
                                GError        **error)
{
        g_autoptr(ScdmManager) manager = NULL;
...
static GDBusConnection *
scdm_client_get_connection_finish (ScdmClient      *client,
                                  GAsyncResult   *result,
                                  GError        **error)
{
        GDBusConnection *connection;
...
static void
scdm_client_get_connection (ScdmClient           *client,
                            GCancellable        *cancellable,
                            GAsyncReadyCallback  callback,
                            gpointer             user_data)
{
 ...
 */
ScdmUserVerifier *
scdm_client_open_reauthentication_channel_sync (ScdmClient     *client,
                                               const char    *username,
                                               GCancellable  *cancellable,
                                               GError       **error)
{
 ...
 */
void
scdm_client_open_reauthentication_channel (ScdmClient           *client,
                                          const char          *username,
                                          GCancellable        *cancellable,
                                          GAsyncReadyCallback  callback,
                                          gpointer             user_data)
 ...
 */
ScdmUserVerifier *
scdm_client_open_reauthentication_channel_finish (ScdmClient       *client,
                                                 GAsyncResult    *result,
                                                 GError         **error)
{
        g_return_val_if_fail (GDM_IS_CLIENT (client), NULL);
 ...
 */
ScdmUserVerifier *
scdm_client_get_user_verifier_sync (ScdmClient     *client,
                                   GCancellable  *cancellable,
                                   GError       **error)
{
        g_autoptr(GDBusConnection) connection = NULL;
 ...
 */
void
scdm_client_get_user_verifier (ScdmClient           *client,
                              GCancellable        *cancellable,
                              GAsyncReadyCallback  callback,
                              gpointer             user_data)
{
 ...
 */
ScdmUserVerifier *
scdm_client_get_user_verifier_finish (ScdmClient       *client,
                                     GAsyncResult    *result,
                                     GError         **error)
{
        ScdmUserVerifier *user_verifier;
...
scdm_client_get_user_verifier_choice_list (ScdmClient *client)
{
        if (client->user_verifier_extensions == NULL)
                return NULL;
 ...
 */
void
scdm_client_get_greeter (ScdmClient           *client,
                        GCancellable        *cancellable,
                        GAsyncReadyCallback  callback,
                        gpointer             user_data)
{
 ...
 */
ScdmGreeter *
scdm_client_get_greeter_finish (ScdmClient       *client,
                               GAsyncResult    *result,
                               GError         **error)
{
        ScdmGreeter *greeter;
 ...
 */
ScdmGreeter *
scdm_client_get_greeter_sync (ScdmClient     *client,
                             GCancellable  *cancellable,
                             GError       **error)
{
        g_autoptr(GDBusConnection) connection = NULL;
 ...
 */
void
scdm_client_get_remote_greeter (ScdmClient           *client,
                               GCancellable        *cancellable,
                               GAsyncReadyCallback  callback,
                               gpointer             user_data)
{
 ...
 */
ScdmRemoteGreeter *
scdm_client_get_remote_greeter_finish (ScdmClient     *client,
                                      GAsyncResult  *result,
                                      GError       **error)
{
        ScdmRemoteGreeter *remote_greeter;
 ...
 */
ScdmRemoteGreeter *
scdm_client_get_remote_greeter_sync (ScdmClient     *client,
                                    GCancellable  *cancellable,
                                    GError       **error)
{
        g_autoptr(GDBusConnection) connection = NULL;
 ...
 */
void
scdm_client_get_chooser (ScdmClient           *client,
                        GCancellable        *cancellable,
                        GAsyncReadyCallback  callback,
                        gpointer             user_data)
{
 ...
 */
ScdmChooser *
scdm_client_get_chooser_finish (ScdmClient       *client,
                               GAsyncResult    *result,
                               GError         **error)
{
        ScdmChooser *chooser;
 ...
 */
ScdmChooser *
scdm_client_get_chooser_sync (ScdmClient     *client,
                             GCancellable  *cancellable,
                             GError       **error)
{
        g_autoptr(GDBusConnection) connection = NULL;
...
static void
scdm_client_class_init (ScdmClientClass *klass)
{
...
static void
scdm_client_init (ScdmClient *client)
{
}
 ...
 */
void
scdm_client_set_enabled_extensions (ScdmClient          *client,
