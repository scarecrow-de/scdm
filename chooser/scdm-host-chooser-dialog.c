...
static void     scdm_host_chooser_dialog_class_init  (ScdmHostChooserDialogClass *klass);
static void     scdm_host_chooser_dialog_init        (ScdmHostChooserDialog      *host_chooser_dialog);

G_DEFINE_TYPE (ScdmHostChooserDialog, scdm_host_chooser_dialog, GTK_TYPE_DIALOG)

ScdmChooserHost *
scdm_host_chooser_dialog_get_host (ScdmHostChooserDialog *dialog)
{
...
static void
_scdm_host_chooser_dialog_set_kind_mask (ScdmHostChooserDialog *dialog,
                                        int                   kind_mask)
{
...
static void
scdm_host_chooser_dialog_class_init (ScdmHostChooserDialogClass *klass)
{
...
static void
scdm_host_chooser_dialog_init (ScdmHostChooserDialog *dialog)
{
}
...
scdm_host_chooser_dialog_new (int kind_mask)
{
        ...
        object = g_object_new (SCDM_TYPE_HOST_CHOOSER_DIALOG,
                               "kind-mask", kind_mask,
                               NULL);
