...
struct ScdmSessionSolarisAuditor
{
...
G_DEFINE_TYPE (ScdmSessionSolarisAuditor, scdm_session_solaris_auditor, SCDM_TYPE_SESSION_AUDITOR)
...
static void
on_username_set (ScdmSessionSolarisAuditor *auditor)
{
        char          *username;
                                 ...
                                 const char *display_device)
{
        ...
        auditor = g_object_new (SCDM_TYPE_SESSION_SOLARIS_AUDITOR,
                                "hostname", hostname,
