...
static void     scdm_session_worker_job_class_init       (ScdmSessionWorkerJobClass *klass);
static void     scdm_session_worker_job_init     (ScdmSessionWorkerJob      *session_worker_job);
static void     scdm_session_worker_job_finalize (GObject         *object);

G_DEFINE_TYPE (ScdmSessionWorkerJob, scdm_session_worker_job, G_TYPE_OBJECT)
...
static gboolean
scdm_session_worker_job_spawn (ScdmSessionWorkerJob *session_worker_job,
                              const char          *name)
{
        GError          *error;
        gboolean         ret;
 ...
 */
gboolean
scdm_session_worker_job_start (ScdmSessionWorkerJob *session_worker_job,
                              const char          *name)
{
        gboolean    res;
...
void
scdm_session_worker_job_stop_now (ScdmSessionWorkerJob *session_worker_job)
{
...
void
scdm_session_worker_job_stop (ScdmSessionWorkerJob *session_worker_job)
{
        int res;
...
static void
scdm_session_worker_job_class_init (ScdmSessionWorkerJobClass *klass)
{
...
static void
scdm_session_worker_job_init (ScdmSessionWorkerJob *session_worker_job)
{
        session_worker_job->pid = -1;
