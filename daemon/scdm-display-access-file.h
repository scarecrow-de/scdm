...
ScdmDisplayAccessFile *scdm_display_access_file_new                     (const char            *username);
gboolean              scdm_display_access_file_open                    (ScdmDisplayAccessFile  *file,
                                                                       GError               **error);
gboolean              scdm_display_access_file_add_display             (ScdmDisplayAccessFile  *file,
                                                                       ScdmDisplay            *display,
                                                                       char                 **cookie,
                                                                       gsize                 *cookie_size,
                                                                       GError               **error);
gboolean              scdm_display_access_file_add_display_with_cookie (ScdmDisplayAccessFile  *file,
                                                                       ScdmDisplay            *display,
                                                                       const char            *cookie,
                                                                       gsize                  cookie_size,
                                                                       GError               **error);

void                  scdm_display_access_file_close                   (ScdmDisplayAccessFile  *file);
