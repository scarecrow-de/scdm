...
gboolean              scdm_launch_environment_start              (GdmLaunchEnvironment *launch_environment);
gboolean              scdm_launch_environment_stop               (GdmLaunchEnvironment *launch_environment);
GdmSession *          scdm_launch_environment_get_session        (GdmLaunchEnvironment *launch_environment);
char *                scdm_launch_environment_get_session_id     (GdmLaunchEnvironment *launch_environment);

GdmLaunchEnvironment *scdm_create_greeter_launch_environment (const char *display_name,
                                                             const char *seat_id,
                                                             const char *session_type,
                                                             const char *display_hostname,
                                                             gboolean    display_is_local);
GdmLaunchEnvironment *scdm_create_initial_setup_launch_environment (const char *display_name,
                                                                   const char *seat_id,
                                                                   const char *session_type,
                                                                   const char *display_hostname,
                                                                   gboolean    display_is_local);
GdmLaunchEnvironment *scdm_create_chooser_launch_environment (const char *display_name,
                                                             const char *seat_id,
                                                             const char *display_hostname);
