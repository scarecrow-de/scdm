...
static void     scdm_xdmcp_chooser_display_class_init    (ScdmXdmcpChooserDisplayClass *klass);
...
static void
scdm_xdmcp_chooser_display_init (ScdmXdmcpChooserDisplay *xdmcp_chooser_display)
{
}
