...
#define SCDM_IS_SESSION_SETTINGS(obj) (G_TYPE_CHECK_INSTANCE_TYPE ((obj), SCDM_TYPE_SESSION_SETTINGS))
#define SCDM_IS_SESSION_SETTINGS_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE ((klass), SCDM_TYPE_SESSION_SETTINGS))
...
struct _ScdmSessionSettings
{
        GObject                   parent;

        /*< private > */
        ScdmSessionSettingsPrivate *priv;
};

struct _ScdmSessionSettingsClass
{
