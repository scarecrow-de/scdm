...
#define SCDM_IS_SESSION_WORKER(obj)         (G_TYPE_CHECK_INSTANCE_TYPE ((obj), SCDM_TYPE_SESSION_WORKER))
#define SCDM_IS_SESSION_WORKER_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE ((klass), SCDM_TYPE_SESSION_WORKER))
