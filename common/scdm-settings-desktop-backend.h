...
G_DECLARE_FINAL_TYPE (GdmSettingsDesktopBackend, scdm_settings_desktop_backend, GDM, SETTINGS_DESKTOP_BACKEND, GdmSettingsBackend)

GdmSettingsBackend        *scdm_settings_desktop_backend_new             (const char* filename);
